...
#components-card-demo-basic .ant-card { margin-bottom: 30px; }`}},{demo:{id:"components-card-demo-border-less"},previewerProps:{background:"grey",title:"No border",filename:"components/card/demo/border-less.tsx",jsx:`import React from 'react';
import { Card } from 'antd';
const App = () => (
...
export default App;
`,description:"<p>A borderless card on a gray background.</p>"}},{demo:{id:"components-card-demo-simple"},previewerProps:{title:"Simple card",filename:"components/card/demo/simple.tsx",jsx:`import React from 'react';
import { Card } from 'antd';
const App = () => (
  <Card
    style={{
...
export default App;
`,description:"<p>You can use <code>Card.Meta</code> to support more flexible content.</p>"}},{demo:{id:"components-card-demo-in-column"},previewerProps:{background:"grey",title:"Card in column",filename:"components/card/demo/in-column.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Cards usually cooperate with grid column layout in overview page.</p>"}},{demo:{id:"components-card-demo-loading"},previewerProps:{title:"Loading card",filename:"components/card/demo/loading.tsx",jsx:`import React, { useState } from 'react';
