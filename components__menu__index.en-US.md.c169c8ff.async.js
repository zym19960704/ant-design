...
export default App;
`,description:"<p>Horizontal top navigation menu.</p>"}},{demo:{id:"components-menu-demo-horizontal-dark"},previewerProps:{debug:!0,title:"Top Navigation (dark)",filename:"components/menu/demo/horizontal-dark.tsx",jsx:`import React, { useState } from 'react';
import { AppstoreOutlined, MailOutlined, SettingOutlined } from '@ant-design/icons';
import { Menu } from 'antd';
const items = [
  {
