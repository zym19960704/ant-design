...
export default App;
`,description:"<p>Customize the dropdown menu via <code>dropdownRender</code>. If you don't need the Menu content, use the Popover component directly.</p>"}},{demo:{id:"components-dropdown-demo-sub-menu"},previewerProps:{title:"Cascading menu",filename:"components/dropdown/demo/sub-menu.tsx",jsx:`import React from 'react';
import { DownOutlined } from '@ant-design/icons';
import { Dropdown, Space } from 'antd';
const items = [
  {
...
export default App;
`,description:"<p>The default trigger mode is <code>hover</code>, you can change it to <code>contextMenu</code>.</p>"}},{demo:{id:"components-dropdown-demo-loading"},previewerProps:{title:"Loading",filename:"components/dropdown/demo/loading.tsx",jsx:`import React, { useState } from 'react';
import { DownOutlined } from '@ant-design/icons';
import { Dropdown, Space } from 'antd';
const items = [
  {
