"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[8706],{14510:function(s,e,l){l.r(e);var r=l(2143),m=l(50250),Z=l(59378),v=l(5648),c=l(74775),a=l(5937),p=l(2068),h=l(74399),C=l(63942),E=l(16073),g=l(24628),f=l(19260),x=l(56140),i=l(5388),P=l(49545),D=l(6965),O=l(49706),w=l(95127),A=l(74418),M=l(73024),u=l(94065),o=l(67294),t=l(96923);function d(){var _=(0,u.eL)(),n=_.texts;return(0,t.tZ)(u.dY,null,(0,t.tZ)(o.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,n[1].value),(0,t.tZ)("li",null,n[2].value)),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(i.Z,{items:[{demo:{id:"components-statistic-demo-basic"},previewerProps:{title:"Basic",filename:"components/statistic/demo/basic.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Add unit through <code>prefix</code> and <code>suffix</code>.</p>"}},{demo:{id:"components-statistic-demo-animated"},previewerProps:{title:"Animated number",filename:"components/statistic/demo/animated.tsx",jsx:`import React from 'react';
import { Col, Row, Statistic } from 'antd';
...
export default App;
`,description:'<p>Animated number with <a href="https://www.npmjs.com/package/react-countup">react-countup</a>.</p>'}},{demo:{id:"components-statistic-demo-card"},previewerProps:{background:"grey",title:"In Card",filename:"components/statistic/demo/card.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Display statistic data in Card.</p>"}},{demo:{id:"components-statistic-demo-countdown"},previewerProps:{title:"Countdown",filename:"components/statistic/demo/countdown.tsx",jsx:`import React from 'react';
import { Col, Row, Statistic } from 'antd';
