...
export default App;
`,description:"<p>\u901A\u5E38\u914D\u5408\u5185\u5BB9\u53CA\u6309\u94AE\u4F7F\u7528\uFF0C\u8868\u793A\u4E00\u4E2A\u6D41\u7A0B\u7684\u5904\u7406\u8FDB\u5EA6\u3002</p>"}},{demo:{id:"components-steps-demo-vertical"},previewerProps:{title:"\u7AD6\u76F4\u65B9\u5411\u7684\u6B65\u9AA4\u6761",filename:"components/steps/demo/vertical.tsx",jsx:`import React from 'react';
import { Steps } from 'antd';
const description = 'This is a description.';
const App = () => (
  <Steps
